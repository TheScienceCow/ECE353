...
-----------------------------  ProcessManager  ---------------------------------
  ...
  behavior ProcessManager
	...
	processTable = new array of ProcessControlBlock{10 of new ProcessControlBlock}
	...
	--add each processControlBlock to the end of freeList
	freeList.AddToEnd(&processTable[0])
	freeList.AddToEnd(&processTable[1])
	freeList.AddToEnd(&processTable[2])
	freeList.AddToEnd(&processTable[3])
	freeList.AddToEnd(&processTable[4])
	freeList.AddToEnd(&processTable[5])
	freeList.AddToEnd(&processTable[6])
	freeList.AddToEnd(&processTable[7])
	freeList.AddToEnd(&processTable[8])
	freeList.AddToEnd(&processTable[9])
	...
	aProcessDied.Init()
      ...
      method GetANewProcess () returns ptr to ProcessControlBlock
        ...
        -- until one is available.
        --
	--essentially the same as GetANewThread from ThreadManager
	var
...
-----------------------------  StartUserProcess  ---------------------------------
	...
	execFile = fileManager.Open("TestProgram1")
